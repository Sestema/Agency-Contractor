    ...
    internal static class ActivityLogTextLocalizer
    {
        ...
        public static string LocalizeDescription(ActivityLogEntry entry)
        {
            ...
            return entry.ActionType switch
            {
                ...
                "AdvanceDeleted" => string.Format(Res("ActLogMsgAdvanceDeletedFmt"),
                    string.IsNullOrWhiteSpace(entry.NewValue) ? ExtractAmount(description) : entry.NewValue,
                    employeeName, entry.FirmName),
